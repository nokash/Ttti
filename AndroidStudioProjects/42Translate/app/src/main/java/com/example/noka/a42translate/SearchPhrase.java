...
public class SearchPhrase extends AppCompatActivity {
    private RecyclerView mRootView;
    private String urlJsonArry = "http://10.42.0.1/42translate/fetchPhrases.php";
    ...
    private static class FakePageAdapter extends RecyclerView.Adapter<FakePageVH> {
        ...
        String the_word, the_id_word, the_lang, the_trans, the_raw, the_translated, _word, word;
        Context context;
